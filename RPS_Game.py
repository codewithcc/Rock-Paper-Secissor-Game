...
def test(my_hand):
    ...
    elif (my_hand == 'R' or my_hand == 'r') and com_hand == 'SECISSOR':
        return 'ME',com_hand
    ...
    elif (my_hand == 'P' or my_hand == 'p') and com_hand == 'SECISSOR':
        return 'COM',com_hand
    ...
    elif (my_hand == 'S' or my_hand == 's') and com_hand == 'SECISSOR':
        return 'DRAW',com_hand
...
while True:
    my_hand = input('R for ROCK/P for PAPER/S for SECISSOR: ')
    data = test(my_hand)
